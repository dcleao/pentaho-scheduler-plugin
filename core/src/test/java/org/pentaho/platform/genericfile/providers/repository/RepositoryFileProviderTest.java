...
public class RepositoryFileProviderTest {
   ...
   * /public/testFolder2
   */
  static class SampleNativeRepositoryUseCase {
    @NonNull
    ...
    public SampleNativeRepositoryUseCase() {
      rootFolder = createSampleNativeFile( ROOT_PATH, "", true );
      rootTree = createSampleNativeTree( rootFolder );

      // ---
      // /home
      homeFolder = createSampleNativeFile( "/home", "home", true );
      homeTree = createSampleNativeTree( homeFolder );

      // ---
      // /public
      publicFolder = createSampleNativeFile( "/public", "public", true );
      publicTree = createSampleNativeTree( publicFolder );

      testFile1 = createSampleTestFile1();
      testFolder2 = createSampleTestFolder2();

      publicTree.setChildren( Arrays.asList(
        createSampleNativeTree( testFile1 ),
        createSampleNativeTree( testFolder2 )
      ) );
    ...
    private static RepositoryFileDto createSampleTestFile1() {
      RepositoryFileDto testFile1 = createSampleNativeFile( "/public/testFile1", "testFile1", false );
    ...
    private static RepositoryFileDto createSampleTestFolder2() {
      RepositoryFileDto testFolder2 = createSampleNativeFile( "/public/testFolder2", "testFolder2", true );
  ...
  @NonNull
  static RepositoryFileTreeDto createSampleNativeTree( @NonNull RepositoryFileDto nativeFile ) {
  ...
  @NonNull
  private static RepositoryFileDto createSampleNativeFile( String path, String name, boolean isFolder ) {
  ...
  static class SampleRepositoryValidatedUseCase {
    @NonNull
    ...
    public SampleRepositoryValidatedUseCase( @NonNull IGenericFileTree tree ) {
      assertNotNull( tree );
      rootTree = tree;
  ...
  @NonNull
  SampleRepositoryValidatedUseCase assertSampleRepositoryTree( IGenericFileTree tree ) {
    return new SampleRepositoryValidatedUseCase( tree );
  }
  ...
  public void testGetTreeDelegatesToFileServiceDoGetTree() throws OperationFailedException {
    ...
    SampleNativeRepositoryUseCase nativeRepositoryUseCase = new SampleNativeRepositoryUseCase();

    FileService fileServiceMock = mock( FileService.class );
    doReturn( nativeRepositoryUseCase.rootTree )
    ...
    assertSampleRepositoryTree( tree );

    verify( fileServiceMock, times( 1 ) )
      .doGetTree( ENCODED_ROOT_PATH, 2, ALL_FILTER, true, false, false );
  }
  ...
  public void testGetTreeRespectsNullChildrenList() throws OperationFailedException {
    ...
    assertNull( nativeRepositoryUseCase.homeTree.getChildren() );
    ...
    SampleRepositoryValidatedUseCase validatedUseCase = assertSampleRepositoryTree( tree );
    assertNull( validatedUseCase.homeTree.getChildren() );
  }
  ...
  public void testGetTreeRespectsEmptyChildrenList() throws OperationFailedException {
    ...
    nativeRepositoryUseCase.homeTree.setChildren( Collections.emptyList() );
    ...
    SampleRepositoryValidatedUseCase validatedUseCase = assertSampleRepositoryTree( tree );
    assertNotNull( validatedUseCase.homeTree.getChildren() );
    assertTrue( validatedUseCase.homeTree.getChildren().isEmpty() );
  }
  ...
  public void testGetTreeTestFile1HasExpectedProperties() throws OperationFailedException {
    ...
    RepositoryObject testFile1 = (RepositoryObject) validatedUseCase.testFile1;
  ...
  public void testGetTreeTestFolder2HasExpectedProperties() throws OperationFailedException {
    ...
    RepositoryObject testFolder2 = (RepositoryObject) validatedUseCase.testFolder2;
